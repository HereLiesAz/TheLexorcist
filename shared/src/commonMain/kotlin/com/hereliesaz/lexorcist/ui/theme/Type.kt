...
internal val LexorcistTypography = Typography(
    displayLarge = TextStyle(fontWeight = FontWeight.Light, fontSize = 52.sp, lineHeight = 60.sp, letterSpacing = (-0.25).sp),
    displayMedium = TextStyle(fontWeight = FontWeight.Light, fontSize = 42.sp, lineHeight = 50.sp),
    displaySmall = TextStyle(fontWeight = FontWeight.Normal, fontSize = 34.sp, lineHeight = 42.sp),
