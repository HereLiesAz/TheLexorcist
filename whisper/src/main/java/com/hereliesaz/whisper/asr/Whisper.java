package com.hereliesaz.whisper.asr;

import android.content.Context;
import android.util.Log;

import com.hereliesaz.whisper.engine.WhisperEngine;
import com.hereliesaz.whisper.engine.WhisperEngineJava;
...
//        this.mWhisperEngine = new WhisperEngineNative(context);
    ...
    public void loadModelFromAssets(String modelAsset, String vocabAsset, boolean isMultilingual) throws IOException {
        File modelFile = copyAssetToCache(modelAsset);
        File vocabFile = copyAssetToCache(vocabAsset);
        loadModel(modelFile.getAbsolutePath(), vocabFile.getAbsolutePath(), isMultilingual);
    }
