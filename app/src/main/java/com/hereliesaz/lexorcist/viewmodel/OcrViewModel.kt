...
class OcrViewModel @Inject constructor(
    ...
    private val _newlyCreatedEvidence = MutableLiveData<Evidence>()
    val newlyCreatedEvidence: LiveData<Evidence> = _newlyCreatedEvidence

    // Placeholder for actual OCR processing and evidence creation logic
    fun performOcrOnUri(uri: Uri, context: Context, caseId: Int, parentVideoId: String?): Evidence {
        ...
        viewModelScope.launch {
            ...
            _newlyCreatedEvidence.postValue(newEvidence)
