...
/* // Commented out Git versioning functions
...
plugins {
    ...
    id("org.jetbrains.kotlin.android") // Version (2.2.10) will be inherited from root project
    id("com.google.dagger.hilt.android") // Version (2.51.1) will be inherited from root project
    id("org.jetbrains.kotlin.plugin.compose") version "2.2.10" // Explicitly set for Kotlin 2.2.10
    id("com.google.devtools.ksp") version "2.2.10-2.0.2" // Explicitly set for Kotlin 2.2.10
}
...
android {
    ...
    defaultConfig {
        ...
        versionCode = 1 // Static version code
        versionName = "1.0.0" // Static version name
    ...
    composeOptions {
        // kotlinCompilerExtensionVersion is managed by the Kotlin Compose plugin 2.2.10
    }
    packaging {
...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.9.3") // Updated for newer Kotlin/BOM
    implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.9.3")
    implementation("androidx.work:work-runtime-ktx:2.10.3")

    // Jetpack Compose - Aligned BOM and dependencies for Kotlin 2.2.10
    val composeBom = "2025.08.01"
    implementation(platform("androidx.compose:compose-bom:$composeBom")) // Corrected BOM usage
    ...
    implementation("androidx.activity:activity-compose:1.10.1") // Updated for newer Kotlin/BOM

    // Coil for image loading
    implementation("io.coil-kt:coil-compose:2.7.0")

    // Navigation Compose
    implementation("androidx.navigation:navigation-compose:2.9.3") // Updated for newer Kotlin/BOM
    ...
    // Hilt - Aligned versions (with root Hilt plugin)
